...
{
    internal class SlowProjectile : TowerProjectile
    {

        public SlowProjectile(Vector2 position, BaseEnemy target)
        {
            texture = Globals.Content.Load<Texture2D>(@"slowprojectile");
